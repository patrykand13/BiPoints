...
namespace BiPoints.ViewModels.Main
{
    ...
    {
        IScanPointsServices _scanPointsServices;
        ...
        public ICommand GoScanCommand => new Command(GoScan);
        internal HomeVM()
        {
        ...
        {
            IsBusy = true;
            var informationData = await _scanPointsServices.GetPointsInformations(ProfileHelper.UserId);
